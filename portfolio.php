...
<body>
	...
	<section id="featureCat2" class="row contentRowPad">
        <div class="container">
            <h3 class="heading">our Best Projects</h3>
            <div class="row m0">
				<?php $service_home_sql=sqlfetch("SELECT  name,photo FROM product where actstat='1' order by fld_order");
