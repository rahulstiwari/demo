<footer class="row">
        <div class="row m0 topFooter">
            ...
            <div class="container line2">
                <div class="row">
                    ...
                    <div class="col-sm-3 widget">
                        <div class="row m0">
                            <h4>Our Prime Work Locations</h4>
                            <ul class="nav">
        ...
        <div class="row m0 copyRight">
            <div class="container">
                <div class="row">
                    <div class="fleft">&copy; 2015 <a href="index.html">Red Take Media</a> All Rights Reserved.</div>
