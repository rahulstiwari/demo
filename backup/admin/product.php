...
if(isset($_POST['addproduct']))
{
	...
	{	
		...
		$Filename=date('dmyhis').basename( $_FILES['photo']['name']);		
				...
				$q=$pdo->prepare("INSERT into `product` values(:id,:name, :photo,:des, :fld_order, :actstat, :subcat)");
...
function product_form($pid='0',$name='',$photo='',$des='',$fld_order='0',$actstat='', $subcat='0',$formname='addproduct')
{ ?>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
			...
			{
				extract($product);
				product_form($pid,$name,$photo,$des,$fld_order,$actstat,$subcat,$formname='editdone');
			} ?>
