...
{ ?>
	<form action="warranty.php" method="post" enctype="multipart/form-data">
	...
	<div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>Edit warranty </h2>
                <div class="box-icon">
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>warranty </h2>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a class="ajax-link" href="warranty.php?&pid=<?php echo $menu['id']; ?>&edit=true">
