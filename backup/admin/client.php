...
if(isset($_POST['addclient']))
{
	...
	$type=1;
	$pdo=getPDOObject();
	$sql=$pdo->query("SELECT * FROM `client` where  name LIKE '$name'");
	$num=$sql->rowCount();
	...
	{	
		...
		$Filename=date('dmyhis').basename( $_FILES['photo']['name']);		
				...
				$q=$pdo->prepare("INSERT into `client` values(:id,:name, :photo,:des, :fld_order, :actstat)");
...
function client_form($pid='0',$name='',$photo='',$des='',$fld_order='0',$actstat='',$formname='addclient')
{ ?>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Edit client</h2>
                <div class="box-icon">
			...
			{
				extract($product);
				client_form($pid,$name,$photo,$des,$fld_order,$actstat,$formname='editdone');
			} ?>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Add client</h2>
                <div class="box-icon">
                    <a href="#" class="btn btn-setting btn-round btn-default"><i
                            class="glyphicon glyphicon-cog"></i></a>
                    <a href="#" class="btn btn-minimize btn-round btn-default"><i
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>client</h2>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<button type="button" class="btn btn-xs btn-danger pull-right" name="editclient">Edit</button>
								</a>
							</td>
						</tr>
						<?php } ?>
