...
function product_form($pid='0',$name='',$photo='',$des='',$day='',$month='',$company_name='',$fld_order='0',$actstat='', $subcat='0',$formname='addproduct')
{ ?>
	<form action="product.php" method="post" enctype="multipart/form-data">
			   ...
			   <label>Name</label>
				...
				<input type="text" name="company_name" value="<?php echo $company_name; ?>" class="form-control" /><br/><br/>
					</span>
				</span>
				<span class="row">
				<span class="col-md-6">
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
			...
			{
				extract($product);
				product_form($pid,$name,$photo,$des,$day,$month,$company_name,$fld_order,$actstat,$subcat,$formname='editdone');
			} ?>
                ...
                <table class="table table-bordered table-striped responsive">
					<tbody>
						...
						<tr>
							...
							<td><?php echo get_subcategory_name($menu['subcat']); ?></td>
