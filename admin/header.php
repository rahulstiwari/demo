                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
						...
						<li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li> <a class="ajax-link" href="subcategory.php">Sub Category</a></li>
                                <li> <a class="ajax-link" href="product.php">Project</a></li>
                                <li> <a class="ajax-link" href="subproduct.php">Project Images</a></li>
                            </ul>
                        </li>
						<li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-th-large"></i><span>CMS</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li> <a class="ajax-link" href="team.php">Team</a></li>
                                <li> <a class="ajax-link" href="banner.php">Banners</a></li>
                                <li> <a class="ajax-link" href="aboutus.php">About Us</a></li>
                                <li><a class="ajax-link" href="home_page.php">Home Page</a></li>
                                <li><a class="ajax-link" href="review.php">Reviews</a></li>
                                <li><a class="ajax-link" href="client.php">Client</a></li>
