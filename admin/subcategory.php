...
if(isset($_POST['addsubcategory']))
{
	...
	$pdo=getPDOObject();
	$posted_data=$_POST;
	$sql=$pdo->query("SELECT * FROM `subcategory` where  name LIKE '$name'");
	$num=$sql->rowCount();
...
function subcategory_form($pid='0',$name='',$photo='',$des='',$fld_order='0',$subcat=0,$actstat='',$formname='addsubcategory')
{ ?>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Edit subcategory</h2>
                <div class="box-icon">
			...
			{
				extract($product);
				subcategory_form($pid,$name,$photo,$des,$fld_order,$subcat,$actstat,$formname='editdone');
			} ?>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Add subcategory</h2>
                <div class="box-icon">
                    <a href="#" class="btn btn-setting btn-round btn-default"><i
                            class="glyphicon glyphicon-cog"></i></a>
                    <a href="#" class="btn btn-minimize btn-round btn-default"><i
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>subcategory</h2>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<button type="button" class="btn btn-xs btn-danger pull-right" name="editsubcategory">Edit</button>
								</a>
							</td>
						</tr>
						<?php } ?>
