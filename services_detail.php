...
$cid=get_category_id($_GET['id']);
$category_sql=sqlfetch("SELECT * FROM `category` where id='$cid' and actstat='1'");
if(count($category_sql))
{
...
<body>
	...
	<section id="featureCat2" class="row contentRowPad">
                ...
                <div class="col-sm-8">                    
                    ...
                    <div class="row m0 flexslider" id="productImageSlider">
                        <ul class="slides">
							...
							<li><img data-tilt src="<?=SITE_URL;?>upload/<?=$category['photo'];?>" alt="<?=$category['name'];?>"></li>
                        ...
                        <div class="row m0 titleRow">
                            <div class="fleft titlePart">
                                <a><h4 class="blogTitle heading"><?=$category['name'];?></h4></a>
                            </div>
                        </div>
        ...
        <hr>
            ...
            <div class="row m0">
				<?php $service_home_sql=sqlfetch("SELECT  name,photo FROM subcategory where actstat='1' and subcat='$cid' order by fld_order");
                    ...
                    <div class=" category2 text-center">
                        <div class="row m0 imgHov">
                            ...
                            <div class="hovArea row m0">
                                <a href="<?=SITE_URL;?>service/<?=urlencode($service_home['name']);?>.html">Check Now <i class="fa fa-caret-right"></i></a>
                            </div>
                        </div>
                        <div class="row m0">
